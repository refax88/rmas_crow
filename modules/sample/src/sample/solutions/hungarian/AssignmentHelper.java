...
public class AssignmentHelper {
    ...
    private static double calculateSum(double costMatrix[][], int assigment[][], double floatMax) {
        double sum = 0;
    ...
    public static double calculateSum(double costMatrix[][], int assigment[][]) {
     ...
     */
    public static double getFloatMax(int n) {
