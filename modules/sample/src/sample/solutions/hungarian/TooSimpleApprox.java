...
/**
 * Use this algorithm in AssignmentManager to test the behaviour.
 * 
 * @author Peter Karich, peat_hal 'at' users 'dot' sourceforge 'dot' net
 */
public class TooSimpleApprox implements AssignmentAlgorithm {
        ...
        for (int col = 0; col < COLUMNS; col++) {            
            ...
            if (!coveredCols[col]) {
                ...
                if (minValInCol < Double.MAX_VALUE) {
                    ...
                    coveredCols[col] = true;
                    result[col] = new int[]{goodRow, col};
                }
            }
        }
        return result;
